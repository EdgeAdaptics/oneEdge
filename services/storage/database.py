...
class ProvisionedDevice(Base):
    ...
    service_account_username = Column(String, nullable=True)
    service_account_secret_hash = Column(String, nullable=True)
    credentials_issued_at = Column(DateTime, nullable=True)
